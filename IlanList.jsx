  ...
  <div className="ilan">
    ...
    <>
          <div className="ilan-listesi">
            {is_ilan_verileri.map((is_ilan_verileri, index)=> (
              <IlanKartları key={index} ilan={is_ilan_verileri}/>   
            ))}
